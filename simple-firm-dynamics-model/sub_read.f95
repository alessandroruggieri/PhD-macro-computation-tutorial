subroutine sub_read
    ...
    read(1,*) alfa      ! Span of control
    read(1,*) delta     ! Exit probability
    read(1,*) ch        ! Linear cost of adjustment
    read(1,*) chc       ! Convexity in capital adjustment
    read(1,*) centry    ! Entry cosy
